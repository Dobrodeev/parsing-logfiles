/**
 Series32. Даны целые числа K, N, а также K наборов целых чисел по N элементов в каждом наборе.
...
for (let i = 0; i <= size; i++) {
    ...
    if (pool [i] == 2 || pool [i] > 2) {
        idx = ++q;
        i += 1;
        console.log(`Номер першого елемента > 2 першого набору: `,i);
    }
